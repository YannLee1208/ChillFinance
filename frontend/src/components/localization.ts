...
const INDICATOR_LABELS: Record<string, LocalizedIndicator> = {
  ...
  US_API_CRUDE_STOCK_CHANGE: { name: "美国 API 原油库存变动", description: "API 原油库存周度变动值，用于补充观察库存边际变化。", unit: "万桶", sourceLabel: "AkShare / Jin10" },
  US_EIA_CRUDE_STOCK_CHANGE: { name: "美国 EIA 原油库存变动", description: "EIA 原油库存周度变动值，用于观察原油供需边际变化。", unit: "万桶", sourceLabel: "AkShare / Jin10" },
