...
def _pbc_indicator(
    ...
    *,
    ...
    return _indicator(
        ...
        frequency="monthly",
        provider="pbc_public",
        source=PBC_PUBLIC_SERIES[code]["source"],
        description=description,
        display_order=display_order,
        selectors=selectors,
    )
...
_CHINA_AKSHARE_EXTRA_INDICATORS = [
    ...
    _indicator(
        code="CN_EXPORT_MOM_USD",
        name="China exports MoM in USD",
        domain="country_macro",
        region="China",
        unit="%",
        frequency="monthly",
        provider="akshare_china",
        source=AKSHARE_CHINA_SERIES["CN_EXPORT_MOM_USD"]["source"],
        description="用海关总署当月出口额计算的环比变化，用于观察外需短期动能。",
        display_order=232,
        selectors=_price_trade_selectors("出口环比", "出口", "trade"),
    ),
    _indicator(
    ...
    _indicator(
        code="CN_IMPORT_MOM_USD",
        name="China imports MoM in USD",
        domain="country_macro",
        region="China",
        unit="%",
        frequency="monthly",
        provider="akshare_china",
        source=AKSHARE_CHINA_SERIES["CN_IMPORT_MOM_USD"]["source"],
        description="用海关总署当月进口额计算的环比变化，用于观察内需和补库短期动能。",
        display_order=242,
        selectors=_price_trade_selectors("进口环比", "进口", "trade"),
    ),
    _indicator(
    ...
    _indicator(
        code="CN_TRADE_BALANCE_USD",
        name="China trade balance in USD",
        domain="country_macro",
        region="China",
        unit="USD 100mn",
        frequency="monthly",
        provider="akshare_china",
        source=AKSHARE_CHINA_SERIES["CN_TRADE_BALANCE_USD"]["source"],
        description="中国海关口径出口额减进口额，正值为顺差，负值为逆差。",
        display_order=250,
        selectors=_price_trade_selectors("顺差/逆差", "顺逆差", "trade"),
    ),
    _indicator(
        code="CN_TRADE_BALANCE_YOY_USD",
        name="China trade balance YoY in USD",
        domain="country_macro",
        region="China",
        unit="%",
        frequency="monthly",
        provider="akshare_china",
        source=AKSHARE_CHINA_SERIES["CN_TRADE_BALANCE_YOY_USD"]["source"],
        description="用海关口径贸易差额计算的同比变化，用于观察顺逆差相对去年同月变化。",
        display_order=251,
        selectors=_price_trade_selectors("顺逆差同比", "顺逆差", "trade"),
    ),
    _indicator(
        code="CN_TRADE_BALANCE_MOM_USD",
        name="China trade balance MoM in USD",
        domain="country_macro",
        region="China",
        unit="%",
        frequency="monthly",
        provider="akshare_china",
        source=AKSHARE_CHINA_SERIES["CN_TRADE_BALANCE_MOM_USD"]["source"],
        description="用海关口径贸易差额计算的环比变化，用于观察顺逆差短期变化。",
        display_order=252,
...
_PBC_FLOW_EXTRA_INDICATORS = [
    _pbc_indicator(
        "CN_SF_RMB_LOAN_FLOW",
        name="China social financing RMB loan flow",
        description="社融口径人民币贷款增量，用于观察信贷进入实体经济的规模。",
        display_order=140,
        metric="社融人民币贷款",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        "CN_SF_FOREIGN_CURRENCY_LOAN_FLOW",
        name="China social financing foreign-currency loan flow",
        description="社融口径外币贷款折人民币增量。",
        display_order=140,
        metric="社融外币贷款",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        ...
        name="China entrusted loan flow",
        description="社融口径委托贷款增量。",
        display_order=140,
        metric="委托贷款",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        ...
        name="China trust loan flow",
        description="社融口径信托贷款增量。",
        display_order=140,
        metric="信托贷款",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        ...
        name="China undiscounted bankers acceptance flow",
        description="社融口径未贴现银行承兑汇票增量。",
        display_order=140,
        metric="未贴现银承",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        ...
        name="China corporate bond financing flow",
        description="企业债券净融资增量。",
        display_order=140,
        metric="企业债券",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        ...
        name="China government bond financing flow",
        description="政府债券融资增量。",
        display_order=140,
        metric="政府债券",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        ...
        name="China equity financing flow",
        description="非金融企业境内股票融资增量。",
        display_order=140,
        metric="股票融资",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        "CN_SF_ABS_FLOW",
        name="China depository ABS financing flow",
        description="存款类金融机构资产支持证券增量。",
        display_order=140,
        metric="ABS",
        compare_group="社融增量结构",
    ),
    _pbc_indicator(
        ...
        name="China loan write-off flow",
        description="贷款核销增量。",
        display_order=140,
        metric="贷款核销",
        compare_group="社融增量结构",
...
_PBC_STOCK_EXTRA_INDICATORS = [
    _pbc_indicator(
        "CN_SF_RMB_LOAN_STOCK",
        name="China social financing RMB loan stock",
        description="社融口径人民币贷款存量。",
        display_order=140,
        metric="社融人民币贷款存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        "CN_SF_FOREIGN_CURRENCY_LOAN_STOCK",
        name="China social financing foreign-currency loan stock",
        description="社融口径外币贷款折人民币存量。",
        display_order=140,
        metric="社融外币贷款存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        ...
        name="China entrusted loan stock",
        description="社融口径委托贷款存量。",
        display_order=140,
        metric="委托贷款存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        ...
        name="China trust loan stock",
        description="社融口径信托贷款存量。",
        display_order=140,
        metric="信托贷款存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        ...
        name="China undiscounted bankers acceptance stock",
        description="社融口径未贴现银行承兑汇票存量。",
        display_order=140,
        metric="未贴现银承存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        ...
        name="China corporate bond financing stock",
        description="企业债券融资存量。",
        display_order=140,
        metric="企业债券存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        ...
        name="China government bond financing stock",
        description="政府债券融资存量。",
        display_order=140,
        metric="政府债券存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        ...
        name="China equity financing stock",
        description="非金融企业境内股票融资存量。",
        display_order=140,
        metric="股票融资存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        "CN_SF_ABS_STOCK",
        name="China depository ABS financing stock",
        description="存款类金融机构资产支持证券存量。",
        display_order=140,
        metric="ABS存量",
        compare_group="社融存量结构",
    ),
    _pbc_indicator(
        ...
        name="China loan write-off stock",
        description="贷款核销存量。",
        display_order=140,
        metric="贷款核销存量",
        compare_group="社融存量结构",
...
_PBC_CREDIT_EXTRA_INDICATORS = [
    _pbc_indicator(
        "CN_RMB_DEPOSIT_BALANCE",
        name="China RMB deposit balance",
        description="金融机构人民币各项存款余额。",
        display_order=141,
        metric="人民币存款余额",
        compare_group="存贷款余额",
    ),
    _pbc_indicator(
        ...
        name="China household deposit balance",
        description="住户人民币存款余额。",
        display_order=141,
        metric="住户存款余额",
        compare_group="存贷款余额",
    ),
    _pbc_indicator(
        ...
        name="China non-financial enterprise deposit balance",
        description="非金融企业人民币存款余额。",
        display_order=141,
        metric="企业存款余额",
        compare_group="存贷款余额",
    ),
    _pbc_indicator(
        ...
        name="China household loan balance",
        description="住户人民币贷款余额。",
        display_order=142,
        metric="住户贷款余额",
        compare_group="贷款余额结构",
    ),
    _pbc_indicator(
        "CN_HOUSEHOLD_SHORT_TERM_LOAN_BALANCE",
        name="China household short-term loan balance",
        description="住户短期贷款余额。",
        display_order=142,
        metric="住户短贷余额",
        compare_group="贷款余额结构",
    ),
    _pbc_indicator(
        ...
        name="China household medium and long-term loan balance",
        description="住户中长期贷款余额。",
        display_order=142,
        metric="住户中长贷余额",
        compare_group="贷款余额结构",
    ),
    _pbc_indicator(
        ...
        name="China enterprise loan monthly change",
        description="企事业单位贷款余额环比计算的月度新增额。",
        display_order=142,
        metric="企业贷款新增",
        compare_group="贷款增量",
    ),
    _pbc_indicator(
        ...
        name="China enterprise short-term loan monthly change",
        description="企事业单位短期贷款余额环比计算的月度新增额。",
        display_order=142,
        metric="企业短贷新增",
        compare_group="企业贷款增量结构",
    ),
    _pbc_indicator(
        "CN_ENTERPRISE_MEDIUM_LONG_TERM_LOAN_INCREMENT",
        name="China enterprise medium and long-term loan monthly change",
        description="企事业单位中长期贷款余额环比计算的月度新增额。",
        display_order=142,
        metric="企业中长贷新增",
        compare_group="企业贷款增量结构",
    ),
    _pbc_indicator(
        ...
        name="China enterprise bill financing monthly change",
        description="企事业单位票据融资余额环比计算的月度新增额。",
        display_order=142,
        metric="企业票据融资新增",
        compare_group="企业贷款增量结构",
    ),
    _pbc_indicator(
        ...
        name="China enterprise loan balance",
        description="企事业单位贷款余额。",
        display_order=142,
        metric="企业贷款余额",
        compare_group="贷款余额结构",
    ),
